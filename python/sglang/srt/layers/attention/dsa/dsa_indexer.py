...
class Indexer(DSANPUIndexerMixin, BaseFusedOp):
    ...
    def forward_cpu(
        ...
        # CPU (AMX) path. `forward_batch` carries the index-key cache of the
        # tokens before this step; see dsa_cpu.DSACPUBatch.
        from sglang.srt.layers.attention.dsa.dsa_cpu import indexer_topk_cpu

        topk = indexer_topk_cpu(self, x, q_lora, positions, forward_batch.index_k_cache)
